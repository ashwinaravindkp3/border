...
#define NODE_ID "BORDER_002"
#define MQTT_USER NODE_ID

const uint8_t AES_KEY[32] = {
  0x54, 0x4b, 0x23, 0x52, 0xc3, 0xca, 0x69, 0xc5,
  0xff, 0x47, 0x93, 0x5d, 0x4e, 0xc2, 0xf2, 0x07,
  0xbc, 0xc6, 0x24, 0xf8, 0x61, 0x3b, 0x44, 0x09,
  0xfe, 0x7a, 0x86, 0x3d, 0x45, 0xbe, 0x98, 0x50
};
...
bool read_rcwl() {
  return digitalRead(RCWL_PIN) == HIGH;
}
...
void loop() {
  ...
  bool detected = read_rcwl();
  if (detected && !last_motion_state && (millis() - last_trigger_ms >= 5000UL)) {
    trigger_camera(90);
    publish_event("motion_detected", 1.0f);
