...
#define NODE_ID "BORDER_003"
#define MQTT_USER NODE_ID

const uint8_t AES_KEY[32] = {
  0xa0, 0x3f, 0xd3, 0xa9, 0x6b, 0x55, 0x56, 0x05,
  0x92, 0x2f, 0xaa, 0xe4, 0xc4, 0xba, 0xa4, 0xfe,
  0xe4, 0x06, 0x1c, 0xf2, 0xc0, 0xc5, 0x7a, 0x95,
  0x8a, 0x11, 0xb8, 0x67, 0x42, 0x68, 0x5c, 0xf3
};
...
void send_lora_beacon() {
  ...
  String msg = String(NODE_ID) + ":" + String(seq_no);
  LoRa.beginPacket();
  LoRa.print(msg);
  LoRa.endPacket();
